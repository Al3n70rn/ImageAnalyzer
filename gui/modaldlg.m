...
% Last Modified by GUIDE v2.5 20-Jun-2012 13:43:57
...
questIconMap(256,:)=get(handles.modaldlg,'color');
IconCMap=questIconMap;

axes(handles.axes1);
Img=image(IconData);
set(handles.modaldlg, 'Colormap', IconCMap);
...
% --- Executes when user attempts to close modaldlg.
function modaldlg_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to modaldlg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

if isequal(get(handles.modaldlg, 'waitstatus'), 'waiting')
...
% --- Executes on key press over modaldlg with no controls selected.
function modaldlg_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to modaldlg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
