...
% Last Modified by GUIDE v2.5 10-Aug-2012 12:52:09
...
if ~isempty(visualizationInput)
    ...
    set(gcf, 'Name', strcat(['Patient: ', handles.study.imageSeriesList{ ...
...
for i = 1:handles.numberOfROIs
    ...
    handles.p{i} = patch(isosurface(double(volume_zp), 0.5));
    set(handles.p{i},'FaceColor',[0.75, 0.75, 0.75],'EdgeColor','none');
